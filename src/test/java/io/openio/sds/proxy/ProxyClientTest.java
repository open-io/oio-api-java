...
public class ProxyClientTest {
	...
	void verifyRequest(TestSocketProvider socketProvider, String method, String path, String data, String reqID) {
	...
	TestSocketProvider newTestSocketProvider(int code, String msg, String data, Map<String, String> headers) {
	...
	public void showReference() {
		...
		String expectedPath = "/v3.0/" + NAMESPACE + "/reference/show?acct=" +
				ACCOUNT_NAME +
				"&ref=" +
				CONTAINER_NAME;
		verifyRequest(
	...
	public void listContainer() {
		...
		String expectedPath = "/v3.0/" + NAMESPACE + "/container/list?" +
				"acct=" + ACCOUNT_NAME +
				"&ref=" + CONTAINER_NAME +
				"&max=" + limit +
				"&prefix=" + prefix +
